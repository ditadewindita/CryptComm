"""
Django settings for Cryptcomm project.
...
SECRET_KEY = 'jhtjcdpy-nb9mdhjaj0$nfn^e*b)mv_-h8it=y@3w5)6(1ee9%'
...
WSGI_APPLICATION = 'Cryptcomm.wsgi.application'
